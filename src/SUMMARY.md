...
* [Chapter7]()
   ...
   * [使用梯度上升法求解PCA问题](Chap7-PCA/7-1.md)
   * [求数据主成分PCA](Chap7-PCA/7-1.md)
   * [求数据的前n个主成分](Chap7-PCA/7-1.md)
   * [高维数据向低维数据映射](Chap7-PCA/7-1.md)
   * [scikit-learn中的PCA](Chap7-PCA/7-1.md)
   * [MNIST 数据集](Chap7-PCA/7-1.md)
